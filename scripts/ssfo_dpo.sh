...
# not require editing this script:  MODEL_REPO_ID=Qwen/Qwen3-4B-Instruct-2507 ./ssfo_dpo.sh
...
#   DEEPSPEED_CONFIG=scripts/deepspeed_config_zero3.yaml ./ssfo_dpo.sh
...
RUN_IDENTIFIER="${USER}/${TASK_NAME}_SSFO_DPO_${MODEL_NAME}_S${SEED}_epo${FORMATTED_EPOCHS}_lr${FORMATTED_LR}_beta${FORMATTED_BETA}_${TIMESTAMP}"
