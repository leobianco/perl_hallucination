...
# not require editing this script:  MODEL_REPO_ID=Qwen/Qwen3-4B-Instruct-2507 ./scope_dpo.sh
...
#   DEEPSPEED_CONFIG=scripts/deepspeed_config_zero3.yaml ./scope_dpo.sh
