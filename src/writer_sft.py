...
It loads datasets, configures LoRA and SFT training arguments, prepares
tokenizers and data collators, and launches training for various prompt-based
tasks (e.g., npov, bosch, ragtruth).

Functions:
    main: Entry point for parsing arguments, preparing data, configuring the
    model, and running SFT training.
